function jsqrscanner() {
    var O = 'bootstrap',
        ...
        Zb = 'jsqrscanner.devmode.js',
        $b = '88507C13C1223C3F2A335CFAAA4EF584',
        _b = '9C51964BB0BBCC41BB79120ED90449EA',
        ac = 'B566A15506556F952CAD2B7994FFA824',
        bc = 'D9940D84355A4C8E89013B8814821244',
        cc = 'F4C3969B01AFD421179360B47BCEA2E0',
        dc = ':',
        ec = '.cache.js',
        fc = 'loadExternalRefs',
        gc = 'end',
        ...
        ic = 'file:',
        jc = '_gwt_dummy_',
        kc = '__gwtDevModeHook:jsqrscanner',
    ...
    jsqrscanner.__sendStats = r;
    jsqrscanner.__moduleName = S;
    jsqrscanner.__errFn = null;
    jsqrscanner.__moduleBase = U;
    jsqrscanner.__softPermutationId = V;
    ...
    jsqrscanner.__moduleStartupDone = function (e) {
        var f = t[S].bindings;
        t[S].bindings = function () {
            var a = f ? f() : {};
            var b = e[jsqrscanner.__softPermutationId];
    ...
    function A(k) {
        ...
        jsqrscanner.onScriptDownloaded = function (a) {
            l(function () {
                m(a)
            })
        };
        ...
        if (jsqrscanner.__errFn) {
            n.onerror = function () {
                jsqrscanner.__errFn(S, new Error(mb + code))
            }
        }
        p.getElementsByTagName(nb)[V].appendChild(n)
    }
    jsqrscanner.__startLoadingFragment = function (a) {
        return D(a)
    };
    jsqrscanner.__installRunAsyncCode = function (a) {
        var b = v();
        var c = b.body;
    ...
    function D(a) {
        ...
        return jsqrscanner.__moduleBase + a
    }
    ...
    function F() {
        ...
        jsqrscanner.__computePropValue = k;
        o.__gwt_activeModules[S].bindings = jsqrscanner.__getPropMap;
        r(O, Yb);
        if (q()) {
            return D(Zb)
        }
        ...
        jsqrscanner.__softPermutationId = g;
        return D(l + ec)
    }
    ...
    B();
    jsqrscanner.__moduleBase = C();
    t[S].moduleBase = jsqrscanner.__moduleBase;
    var H = F();
    if (o) {
